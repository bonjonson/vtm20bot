...
def mess(message):
    ...
    if get_message_bot == "главное меню":  # возврат в главное меню
        ...
        markup.add(types.InlineKeyboardButton("Перейти на studio101.ru", url="https://studio101.ru"))
        bot.send_message(message.chat.id,
                         'Вы можете самостоятельно ознакомиться с книгами правил на сайте wod.su или приобрести официальную книгу правил на сайте studio101.ru',
